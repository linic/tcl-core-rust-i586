...
- `2026-04-27` — Docker build for 1.95.0 completed successfully. All 22 artifacts landed in `release/1.95.0/`. The `load-test.sh` step ran `cargo new test-app-1 && cargo run` inside the container and printed "Hello, world!" — rust 1.95.0 confirmed working on the i586 TCL image.
