...
See [github-release-download.sh](./tools/github-release-download.sh)

## Alternate download method
The artifacts at [http://tcz.facedebouc.sbs](http://tcz.facedebouc.sbs) might not always download
because [of limitations](http://tcz.facedebouc.sbs/#limit)

Since [http://tcz.facedebouc.sbs](http://tcz.facedebouc.sbs) is a partial mirror for 16.x/x86 and 17.x/x86, when running tinycorelinux, it's simpler to use `tce-load -w rust-i586.tcz` and `tce-load -i rust-i586.tcz` to download and load these than from the github releases.

See also [the how-to on tcz.facedebouc.sbs](http://tcz.facedebouc.sbs/#how-to).
